...
\section{Class imbalance in machine learning}
...
% Give a brief introduction of the concept of class imbalance, of majority and minor classes, how classification algorithms lose accuracy in these scenarios, give an introduction to the three main balancing approaches: algorithmic approach, data preprocessing approach, feature selection approach. Show table of each approach type and some exemple methods. Talk about techniques of balancing like Over or Underssampling.

\subsection{Over Sampling Methods}

%Explain how it works, give examples

\subsection{Under Sampling Methods}
