...
These studies indicate that multi-class imbalance affects model training across a wide range of contexts, reducing performance. Datasets from different domains exhibit distinct characteristics and achieve better results through varied balancing and classification methods, highlighting the potential value of developing a recommendation tool for managing class imbalance.
