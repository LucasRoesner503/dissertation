...
\thesistitle{Software tool for multi-class imbalance classification} 

\author{João Lucas \textsc{Roesner}} %\authorname

\subjectarea{Software Engineering} % \areaname

%\advisor{Dr. Fátima \textsc{Rodrigues}} % \advname
...
\supervisor{Dr. Fátima \textsc{Rodrigues}} % Your supervisor's (company, hosting institution mentor) name, this is used in the title page, print it elsewhere with \supname (comment, if no supervisor, or same as advisor)
...
\university{\href{https://www.isep.ipp.pt/}{Instituto Politécnico do Porto}} % \univname

\department{\href{https://www.isep.ipp.pt/Department/Department/14}{Informatics Engineering}} %  \deptname
